...
import githubStarredReposService from '../../src/Services/GithubStarredReposService';
import reposService from '../../src/Services/ReposService';

chai.use(sinonChai);
sinonStubPromise(sinon);

describe('Services/GithubStarredReposService', () => {
    ...
    describe('getByUsername', () => {
        ...
        beforeEach(() => {
            ...
            getByUsernameStub = sinon.stub(
                githubStarredReposService,
                'getByUsername'
            );

            axiosGetReposStub
                .withArgs(
                    `${GITHUB_API_URL}/users/${reposWithUnderlineKeys[0].owner.name}/starred`
                )
        ...
        context('Successful request - status 200', () => {
            it('Should return the repos array of informations when username exists', async () => {
                ...
                const userReposArray = await githubStarredReposService.getByUsername(
